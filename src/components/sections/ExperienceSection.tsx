...
const TimelineItem = ({ 
  ...
  return (
    ...
    >
      {/* Content Card */}
      <motion.div
        className={`flex-1 glass p-6 rounded-2xl ${isLeft ? "md:text-right" : "md:text-left"}`}
      ...
      >
        ...
        <p className="text-primary/80 text-sm mb-3">{item.organization}</p>
      ...
      <div className="hidden md:flex flex-col items-center">
        <motion.div
          className="w-12 h-12 rounded-full glass flex items-center justify-center z-10"
  ...
  return (
    <section id="experience" className="py-32 relative">
      ...
      <div className="container mx-auto px-6">
        ...
        {/* Timeline */}
        <div className="space-y-8 md:space-y-12 max-w-4xl mx-auto relative">
            ...
            {certifications.map((cert, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-muted-foreground text-xs ml-2">• {cert.issuer}</span>
                </div>
              </motion.div>
            ))}
          </div>
